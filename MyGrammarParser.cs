...
public partial class MyGrammarParser : Parser {
	...
	private ExpressionContext expression(int _p) {
		...
		try {
			...
			case T__5:
				...
				State = 6; ((UnaryExpressionContext)_localctx).right = expression(7);
				}
				break;
			case T__6:
				{
			...
			while ( _alt!=2 && _alt!=global::Antlr4.Runtime.Atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						State = 27; ((MultiplicativeExpressionContext)_localctx).right = expression(9);
						}
						break;
					case 2:
						{
						...
						State = 30; ((AdditiveExpressionContext)_localctx).right = expression(7);
						}
						break;
					}
					} 
	...
	public ExprListContext exprList() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__4) | (1L << T__5) | (1L << T__6) | (1L << T__7) | (1L << T__9) | (1L << CELL) | (1L << NUMBER))) != 0)) {
				{
