...
namespace Lab01._2
{
    public partial class MainPage : ContentPage
    {
        ...
        private void SaveButtonClicked(object sender, EventArgs e)
        {
            ...
            string file_name = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), "Lab01.2.Grid.xlsx");
        ...
        {
            string info = @"Лабораторна робота 1. Варіант 2. Виконана студенткою 2 курсу Афанасенко Яриною";
